...
export default function Perks({selected,onChange}) {
  ...
  return (
    <>
        <label className='border gap-2 flex item-center p-4 rounded-full cursor-pointer'>
        ...
        <label className='border flex item-center p-4 gap-2 rounded-full'>
        ...
        <label className='border flex item-center p-4 gap-2 rounded-full'>
            <input type='checkbox' checked={selected.includes('space')} name='space' onChange={handleCbClick} />
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
